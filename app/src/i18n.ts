...
export const strings = {
  ...
  statsTitle: "Playback and decode",
  statsUnavailable: "Playback statistics are not available for this session.",
  statsRefresh: "Refresh statistics",
  statsRefreshing: "Refreshing statistics…",
  statsRefreshed: "Statistics refreshed.",
  statsNoRows: "No per-output statistics were reported.",
  statsRss: "Daemon RSS",
  statsRssUnavailable: "unavailable",
  statsGovernor: "Governor",
  statsGovernorRunning: "running",
  statsGovernorPaused: "paused",
  statsDecode: "Decode",
  statsDecodeHardware: "hardware",
  statsDecodeSoftware: "software",
  statsDecodeUnknown: "unknown",
  statsFps: "FPS",
  statsPosition: "Position",
  statsBuffers: "Buffers",
  statsMode: "Mode",
  statsFrames: "Frames",
  statsFailed: "Playback failed",
  playbackUnavailable: "Playback controls are available only for moving content.",
  playbackPlay: "Play",
  playbackPause: "Pause",
  playbackSeek: "Seek",
  playbackSeekSeconds: "seconds",
  playbackLoopStart: "start",
  playbackLoopEnd: "end",
  playbackApplyLoop: "Apply loop",
  playbackUpdated: "Playback updated.",
  playbackPositionUnavailable: "position unavailable",
